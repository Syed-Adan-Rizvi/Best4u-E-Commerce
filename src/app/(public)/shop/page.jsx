...
export default function ShopPage() {
  ...
  // 🟢 2. URL SYNC LOGIC (Refresh ya direct link ke liye)
  useEffect(() => {
  ...
  const fetchProducts = useCallback(
    async (pageNum = 1, isLoadMore = false, explicitCat = null, explicitSort = null, explicitSearch = null) => {
      ...
      try {
        ...
        const searchToFetch = explicitSearch !== null ? explicitSearch : currentSearch;
    ...
    [currentSearch, selectedCategory, sortBy]
  );
