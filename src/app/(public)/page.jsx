...
export const revalidate = 60; // Production ready cache
import HeroSection from "@/components/public/HeroSection";
import TrustBadges from "@/components/public/TrustBadges";
import ShopByCategories from "@/components/public/ShopByCategories";
import FlashDeals from "@/components/public/FlashDeals"; // 🟢 NEW: Flash Deals Import
...
export default async function HomePage() {
  ...
  // 2. Fetch Top Featured Product Images
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FAF8F5]">
      ...
      {/* ⚡ NEW: Flash Deals Section Placed Here */}
      <FlashDeals />
