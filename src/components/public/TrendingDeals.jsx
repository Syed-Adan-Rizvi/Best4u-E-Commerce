...
export default async function TrendingDeals() {
  ...
  // 🟢 LOGIC UPDATE: Sirf wo products lao jinke clicks 0 se zyada hon ($gt: 0)
  ...
  // Agar database mein koi trending product nahi hai, toh section hide kar do
        ...
        <div className="relative -mx-4 px-4 sm:mx-0 sm:px-0">
          <div className="flex gap-4 sm:gap-6 overflow-x-auto snap-x snap-mandatory hide-scrollbar pb-8 pt-2">
            {plainProducts.map((product) => (
              <div key={product._id} className="snap-start flex-shrink-0 w-[260px] sm:w-[280px]">
