    ...
    return (
      <div className="h-[300px] w-full mt-4">
        <ResponsiveContainer width="100%" height="100%">
          {/* 🟢 FIX 1: Margin left -20 se 0 kiya taake chart left par zayada na ghuse */}
          <ComposedChart data={data} margin={{ top: 10, right: 20, left: 0, bottom: 10 }}>
            ...
            {/* 🟢 FIX 2: XAxis mein padding add ki taake pehla aur aakhri naam cut na ho */}
            <XAxis 
              dataKey="name" 
              axisLine={false} 
              tickLine={false} 
              tick={{ fill: '#8FA397', fontSize: 12 }} 
              dy={10} 
